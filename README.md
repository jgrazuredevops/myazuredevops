Création d'une petite application en Reactjs permettant de mettre en valeur le maximum d'éléments vus en formation (ES5,ES6, React, Redux, hooks, appels API, ... ) 
